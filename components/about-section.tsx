        ...
        <div className="grid gap-16 lg:grid-cols-2 lg:gap-20 items-center">
          ...
          >
            {stats.map((stat, i) => (
              <div
                key={stat.label}
                className={`glass-card rounded-2xl p-6 sm:p-8 text-center transition-all duration-700 hover-lift ${
                  inView ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"
                }`}
                style={{ transitionDelay: `${i * 100 + 400}ms` }}
              >
                <div className="font-serif text-4xl sm:text-5xl font-bold text-foreground">
